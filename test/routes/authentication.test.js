...
describe('/auth', () => {
  ...
  describe('/auth/login', () => {
    it('should login for user1', async () => {
      ...
      const loginResponse = await request(app.listen())
        .post('/auth/login')
        .send({
  ...
  describe('/auth/logout', () => {
    it('should logout for user1', async () => {
      ...
      const logoutResponse = await request(app.listen()).delete('/auth/logout');
  ...
  describe('/auth/getNewAccessToken', () => {
    it('should get new access token for user1', async () => {
      ...
      const newAccessTokenResponse = await request(app.listen())
